    ...
    <nav className="bg-white shadow-md fixed w-full z-50">
      ...
      {menuOpen && (
        <div className="md:hidden bg-white px-4 pb-4 pt-2 shadow-md space-y-2">
          ...
          <Link href="/auth/student" className="block text-gray-700 hover:text-blue-600">Student Login/Register</Link>
          <Link href="/teacher/login" className="block text-gray-700 hover:text-blue-600">Teacher Login/Register</Link>
          <Link
            href="/ask"
